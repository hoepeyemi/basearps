...
interface CheckBetProps {
  selectedBetType: string;
  onClickPlayAgainButton: () => void;
  lastResult: number;
}

const CheckBet: React.FC<CheckBetProps> = ({ selectedBetType, onClickPlayAgainButton, lastResult }) => {
    ...
    console.log("gameresult", selectedBetType, housePickedResult, isChecked);
